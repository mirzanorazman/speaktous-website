  ...
  <main class="px-8 sm:px-12 md:px-20">
    <div class="section-1 flex flex-wrap py-6 items-center">
      <div class="w-full sm:pt-10 sm:w-3/5">
        ...
        <div class="section-desc sm:pr-12 text-center sm:text-left">
          <p class="text-lg sm:text-4xl font-body mt-2 sm:mt-6">Be part of a changing community.</p>
          <p class="text-lg sm:text-4xl font-body my-2 sm:my-6">Be a listener.</p>
    ...
    <div class="section-2 flex flex-wrap py-6 mb-2 sm:mb-8">
      <div class="w-full sm:pt-10 text-center">
        <div class="sm:w-full">
          <h1 class="text-center font-heading font-extrabold text-2xl sm:text-5xl">As Our Listener..</h1>
          <svg class="w-24 h-2 object-center inline-block">
            <rect class="w-24 h-2 bg-green" style="fill:green" />
          </svg>
        </div>
      ...
      <div class="mt-8 w-full flex flex-wrap justify-around">
        <div class="w-full sm:w-1/4 text-center p-6 sm:p-0">
          ...
          <h3
            class="font-body inline-block mt-4"
          >Attend and listen to our responder during online session</h3>
        </div>
        <div class="w-full sm:w-1/4 text-center p-6 sm:p-0">
          <FileIcon class="w-40 h-auto inline-block" />
          <h3 class="font-body mt-8 inline-block">Maintain confidentiality about student's issues</h3>
        </div>
      </div>
    </div>

    <div class="section-3 flex flex-col-reverse sm:flex-row flex-wrap py-6 mt-4 sm:mt-10">
      ...
      <div class="w-full sm:w-1/2 px-6 text-center sm:text-left">
        ...
        >Why Be A Listener?</h1>
        <svg class="w-24 h-2 inline-block">
          <rect class="w-24 h-2 bg-green" style="fill:green;" />
        </svg>
        <ul class="list-disc text-left mt-8 sm:mt-0">
          <li class="font-body">Be an active peer support.</li>
          <li class="font-body mt-1">Get involved in mental health support training.</li>
          <li class="font-body mt-1">Gain experience in conflict management.</li>
        </ul>
      </div>
    </div>
  </main>
